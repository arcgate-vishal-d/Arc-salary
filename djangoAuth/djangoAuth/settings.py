...
SECRET_KEY = 'django-insecure-^%t4mcc^58y8jdh5=+6)@unws#p*atxchhkci(@$r013ol)1b-'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    # If we want to connect our project to the frontend so we need to install corsheader
